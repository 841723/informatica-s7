...
#define U1RXPIN RPINR18bits.U1RXR = 34; // RP34 (Pin 6) to U1RX
#define U1RXTRIS TRISBbits.TRISB2 = 1;  // RB2 (RPI34) as Input for U1RX
#define U1TXPIN RPOR0bits.RP35R = 1;    // U1TX to RP35 (Pin 7)
